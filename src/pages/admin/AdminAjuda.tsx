...
const steps = [
  ...
  },
  {
    ...
    items: [
      ...
      'O switch "Exibir link de pagamento" começa desligado — o cliente vê a proposta sem botão de pagar.',
      'Quando o cliente aprovar, ligue o switch e preencha o link de pagamento (PIX ou outro).',
      'Após confirmar o recebimento, marque o status da proposta como Pago.',
  ...
  },
  {
    ...
    items: [
      ...
      'Na tabela, veja o breakdown de cada proposta: valor bruto, comissão Guatá e valor líquido do parceiro.',
  ...
  },
  {
    ...
    items: [
      ...
      'Clique em "Aprovar e Criar Login" para ativar a agência e gerar acesso ao portal.',
      'Informe o email e nome do responsável; uma senha temporária será gerada para enviar ao parceiro.',
