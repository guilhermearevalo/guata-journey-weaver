    ...
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <Button className="mt-4" asChild>
          <Link to="/minha-conta/viagens">Voltar para Viagens</Link>
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <Badge className={`ml-auto ${statusColors[request.status]}`}>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-medium">{request.destination || 'Não informado'}</p>
            </div>
          </div>
          {travelDates?.start && (
            <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-medium">{request.travelers_count || 1} pessoa(s)</p>
            </div>
          </div>
        ...
        {request.special_requests && (
          <>
            ...
            <CardContent className="pt-4">
              ...
              <p className="mt-1">{request.special_requests}</p>
            </CardContent>
          </>
        )}
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {proposals?.length
              ? `${proposals.length} proposta(s) para sua viagem`
              : 'Aguardando propostas dos nossos parceiros'}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {proposalsLoading ? (
                      ...
                      <ul className="text-sm space-y-1">
                        ...
                        {proposal.inclusions.length > 4 && (
                          <li className="text-muted-foreground">
                            +{proposal.inclusions.length - 4} itens
                          </li>
                        )}
                      </ul>
                    </div>
            ...
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Nossa equipe está trabalhando para encontrar as melhores opções.
              </p>
            </div>
          )}
        </CardContent>
